...
/**
 * @file pronic.cpp
 * @brief Program sederhana untuk mengecek apakah sebuah input angka merupakan bilangan pronic atau bukan.
 * Bilangan pronic adalah bilangan yang merupakan hasil perkalian dari suatu angka dengan angka selanjutnya.
 * Rumus umum:
 * n ( n + 1 )
 * Contoh sederhana:
 * 3 4 = 12 -> 12 merupakan bilangan pronic.
 * */
 ...
 * lalu memeriksa apakah hasil perkalian angka tersebut dengan angka selanjutnya
 * sama dengan angka input
 * 
